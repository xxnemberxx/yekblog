...
class Homepage extends Controller
{
    ...
    public function category($slug){
      ...
      /*
      Kategoriye ait statüsü online olan bütün makaleleri çeker.
      Yüklenme tarihine bakılarak küçükten büyüğe sıralama yapar
      @paginate(5) -> her 10 makalede bir yeni sayfa oluşturur.
      */
    ...
    public function contactpost(Request $request){
      ...
      // make($request , $rules, $messages) -> hataya göre istediğiniz mesaj arrayini oluşturup fonksiyona tanımlayabilirsiniz.
      ...
      // .env email bilgilerinizi girmeniz gerekmektedir.
      // eğer localden yolluyorsanız mail kontrolu için 3. şahıs uygulamalara izin veriniz.
      Mail::send([],[], function($message) use($request){
        $message->from('yekelektronik@gmail.com','Blog Sitesi');
        $message->to('yekelektronik@gmail.com');
